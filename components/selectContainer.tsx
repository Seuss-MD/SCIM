...
import { StyleSheet, Image, TextInput, TouchableOpacity, View, Alert } from 'react-native';
...
export default function EditItemScreen() {
  ...
  const { id, selectedContainerId } = params;
  ...
  useEffect(() => {
    ...
    const initialContainerId =
      selectedContainerId !== undefined
        ...
        : foundItem.container_id ?? null;

    setCurrentContainerId(initialContainerId);

    if (initialContainerId != null) {
      setSelectedContainer(getContainerById(initialContainerId));
    } else {
      setSelectedContainer(null);
    }
  }, [id, selectedContainerId, navigation]);
    ...
    >
      <ThemedView style={styles.container}>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            router.push({
              pathname: `/item/select-container/${id}`,
              params: {
                selectedContainerId:
                  currentContainerId == null ? 'none' : String(currentContainerId),
              },
            })
          }
        >
          {selectedContainer ? (
            ...
            <View style={styles.containerPreview}>
              <View style={[styles.containerImage, styles.containerImagePlaceholder]} />
              <View style={styles.containerPreviewText}>
                <ThemedText style={styles.containerName}>No Container</ThemedText>
                <ThemedText style={styles.containerHint}>
